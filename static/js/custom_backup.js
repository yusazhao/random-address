...
// Removed complex restore function - using simplified approach
...
function initErrorHandling() {
  window.addEventListener('error', function(e) {
    ...
    // Removed automatic error toast to avoid user confusion
  });
...
// Simplified cleanup - removed complex mechanisms that may cause errors
